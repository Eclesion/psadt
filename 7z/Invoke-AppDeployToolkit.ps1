...
$Global:Pkg = @{
    ...
    Lang         = 'en-US'
    Revision     = '01'
    InstallTitle = '7-Zip 26.0 (x64)'
    #================================================
    # Installer
    #================================================
    InstallerType = 'EXE'
    InstallerFile = '7z2600-x64.exe'
    UninstallFile = '7z2600-x64.exe'
    ...
    # Detection Strategy
    #================================================
    DetectionHandling = 'Internal'
    DetectionMode     = 'Uninstall'

    # --- Uninstall detection ---
    DetectDisplayNameRegex = '^7-Zip\s+\d+'
    DetectMinVersion       = '26.0'

    # --- EXE detection (fallback or primary) ---
    DetectExePaths = @(
        @{
